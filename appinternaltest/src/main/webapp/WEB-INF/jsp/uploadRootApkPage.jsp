    ...
    <script>
        $(function () {
            ...
            function UpladFile() {
                ...
                var FileController = "uploadRootApk"; // 接收上传文件的后台地址
                // FormData 对象
                var form = new FormData();
                form.append("file", fileObj); // 文件对象
                form.append("fileName", fileObj.name); // 文件名称
                // XMLHttpRequest 对象
                ...
                xhr.onload = function (data) {
                    ...
                    window.location = GetUrlPath()+'/channel'
...
<h2 class="text-center" style="margin-top: 20px">上传母包</h2>
...
<div class="panel-body">
    ...
    <div class="text-center">
        <button id="uploadBtn" style="margin-top: 50px;margin-bottom: 50px;padding-top: 20px;padding-bottom: 20px;
